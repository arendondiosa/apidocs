...
"""
from flask import Flask, request, redirect, Response, jsonify, g
...
def requires_basic_auth(f):
    ...
    def decorated(*args, **kwargs):
        ...
        encoded_token = request.args.get('encoded_token', None)
        # auth = request.authorization

        if encoded_token in g:
            print '///////before', encoded_token, g.pop('enconded_token', None)
        else:
            print '///////before None', encoded_token

        if encoded_token:
            g.encoded_token = encoded_token

        print '........', g.pop('enconded_token', None)
